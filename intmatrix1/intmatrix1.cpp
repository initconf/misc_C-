...
char* intmatrix1::itoa(int num, char * str, int base=10)
{
...
void intmatrix1::init(int r, int c)
{
    _row = r ;
    _col = c ;
...
void intmatrix1::init(int r, int c, int value)
{
    _row = r ;
    _col = c ;
...
void intmatrix1::print(string str) const
{
...
bool intmatrix1::isEqual(intmatrix1 sec)
{
...
intmatrix1 intmatrix1::add(const intmatrix1 &sec)
{
...
intmatrix1 intmatrix1::mult(const intmatrix1 &sec)
{
